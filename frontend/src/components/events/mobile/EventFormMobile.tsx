...
export default function EventFormMobile({ existingEvent }: EventFormMobileProps) {
  ...
  return (
    <div className="mobile-safe-bottom px-4 py-6">
      ...
      <p className="mt-1 text-sm text-slate-500">
        {isEditMode ? "Update the details and save." : "Fill in your event details."}
      </p>
      ...
      <form className="mt-6 space-y-4" onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-4">
            <div className="flex h-16 w-24 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-dashed border-slate-200 bg-slate-50">
              {previewUrl ? (
