...
export default function GuestFormMobile({
  eventId,
  open,
  existingGuest,
  onClose,
}: GuestFormMobileProps) {
        ...
        <div className="fixed inset-0 z-50">
          ...
          >
            ...
            <form className="space-y-4 px-4 py-5" onSubmit={handleSubmit(onSubmit)} noValidate>
              ...
              <div className="space-y-1.5">
                <Label htmlFor="m_mobile_number">Mobile number</Label>
                <Input
                  id="m_mobile_number"
                  inputMode="numeric"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="m_family_member_count">Family members</Label>
                <Input
                  id="m_family_member_count"
                  type="number"
                  min={0}
                  max={50}
